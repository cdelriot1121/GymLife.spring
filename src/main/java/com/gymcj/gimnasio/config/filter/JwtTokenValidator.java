...
public class JwtTokenValidator extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(@NonNull HttpServletRequest request,
        ...
        // obtencion del token (recodar que se envia en el header de la peticion)
        ...
        if (jwtToken != null) { // Bearer mkdmsvjskdcmdjnskdcdknfhvgcfhyghj
            ...
            String stringAutorizaciones = jwtUtils.getClaimEspeficico(decodedJWT, "permisos").asString();
